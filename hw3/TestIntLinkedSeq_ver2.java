/*
   This file tests toArray(), clone(), reverse(), subSeq(), addAll(), and catenation().
*/
public class TestIntLinkedSeq_ver2
{
   public static void main(String[ ] args)
   {
      ...
      IntLinkedSeq listCopy = new IntLinkedSeq(seq1);  // make a copy of seq1
      if (listCopy == seq1)
      {
         System.out.println("4. There is something wrong with clone().");
         System.exit(-1);
      }
      if ( listCopy.size() != 6 || !listCopy.toString().equals("[92, 82, 72, 62, 52, 42]") )
      {
         System.out.println("5. There is something wrong with clone().");
      ...
      if ( seq1.size() != 6 || !seq1.toString().equals("[92, 82, 72, 62, 52, 42]") )
      {
         System.out.println("6. There is something wrong with clone().");
         System.out.println( listCopy );
         System.exit(-1);
      }
      ...
      listCopy.start();
      listCopy.advance();
      listCopy = new IntLinkedSeq(listCopy);  // clone with a cursor
      if ( listCopy.size() != 4 || !listCopy.toString().equals("[82, 72*, 62, 52]") )
      {
         System.out.println("7. There is something wrong with clone().");
         System.out.println( listCopy );
         System.exit(-1);
      }

      IntLinkedSeq reversed = listCopy.reverse();
      ...
      IntLinkedSeq subSeq = seq1.subSeq(1, 4);
      ...
      IntLinkedSeq concat = seq1.catenation( seq2 );
